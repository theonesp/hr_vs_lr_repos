-- Co-morbididies from pasthistory table
...
SELECT
 ...
 MAX (CASE WHEN ph.pasthistorypath IN (
   ...
   THEN 1 ELSE 0 END) AS comorb_metastases,
 ...
 MAX (CASE WHEN ph.pasthistorypath IN (
   ...
   THEN 1 ELSE 0 END) AS comorb_cirrhosis,
 MAX (CASE WHEN ph.pasthistorypath IN (
		...
		THEN 1 ELSE 0 END) AS comorb_stroke,
 MAX (CASE WHEN ph.pasthistorypath IN (
		...
		THEN 1 ELSE 0 END) AS comorb_renal_fail,
 MAX (CASE WHEN ph.pasthistorypath IN (
 ...
 MAX (CASE WHEN ph.pasthistorypath IN (
   ...
   THEN 1 ELSE 0 END) as comorb_cancer,
 MAX (CASE WHEN ph.pasthistorypath IN (
   ...
   THEN 1 ELSE 0 END) as comorb_leukemia,
 MAX (CASE WHEN ph.pasthistorypath IN (
   ...
   THEN 1 ELSE 0 END) as comorb_lymphoma,
 MAX (CASE WHEN ph.pasthistorypath IN(
 ...
 MAX (CASE WHEN ph.pasthistorypath IN (
   ...
   THEN 1 ELSE 0 END) AS comorb_chf,
 ...
 MAX (CASE WHEN ph.pasthistorypath IN (
     ...
     THEN 1 ELSE 0 END) AS comorb_tia,
 ...
 MAX (CASE WHEN ph.pasthistorypath IN (
   ...
   THEN 1 ELSE 0 END) AS comorb_copd,
 MAX (CASE WHEN ph.pasthistorypath IN (
   ...
   THEN 1 ELSE 0 END) AS comorb_ctd,
 MAX (CASE WHEN ph.pasthistorypath IN (
